...
def annotations_validator(annotations: T.List[T.Union[str, T.List[str]]]) -> T.Optional[str]:
    """Validate mdbus-codegen annotations argument"""
...
class GnomeModule(ExtensionModule):
    ...
    def __init__(self, interpreter: 'Interpreter') -> None:
        ...
        self.methods.update({
            ...
            'mdbus_codegen': self.mdbus_codegen,
    ...
    @staticmethod
    def _print_mdbus_warning() -> None:
        mlog.warning('Code generated with mdbus_codegen() requires the root directory be added to\n'
    ...
    @typed_pos_args('gnome.mdbus_codegen', str, optargs=[(str, mesonlib.File, CustomTarget, CustomTargetIndex, GeneratedList)])
    @typed_kwargs(
        'gnome.mdbus_codegen',
        _BUILD_BY_DEFAULT.evolve(since='0.40.0'),
    ...
    def mdbus_codegen(self, state: 'ModuleState', args: T.Tuple[str, T.Optional[T.Union['FileOrString', build.GeneratedTypes]]],
                      kwargs: 'GdbusCodegen') -> ModuleReturnValue:
        namebase = args[0]
        xml_files: T.List[T.Union['FileOrString', build.GeneratedTypes]] = [args[1]] if args[1] else []
        cmd: T.List[T.Union['ToolType', str]] = [self._find_tool(state, 'mdbus-codegen')]
        ...
        cfile_custom_target = CustomTarget(
            ...
            description='Generating mdbus source {}',
        )
        ...
        hfile_custom_target = CustomTarget(
            ...
            install_dir=[install_dir],
            install_tag=['devel'],
            description='Generating mdbus header {}',
        )
        ...
        if kwargs['docbook'] is not None:
            ...
            docbook_custom_target = CustomTarget(
                ...
                build_by_default=build_by_default,
                extra_depends=depends,
                description='Generating mdbus docbook {}',
            )
