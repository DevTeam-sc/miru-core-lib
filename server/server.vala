namespace Miru.Server {
	private static Application application;

	private const string DEFAULT_DIRECTORY = "re.miru.server";
	...
	private static int main (string[] args) {
...
#if DARWIN
		if (Path.get_basename (args[0]) == "miru-policyd") {
		...
		int prefix_pos = program_path.last_index_of (Config.MIRU_PREFIX + "/");
...
#if DARWIN
		var worker = new Thread<int> ("miru-server-main-loop", () => {
