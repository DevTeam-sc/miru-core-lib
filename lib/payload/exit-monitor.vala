namespace Miru {
	public sealed class ExitMonitor : Object, Mumu.InvocationListener {
...
#if WINDOWS
			interceptor.attach ((void *) Mumu.Process.find_module_by_name ("kernel32.dll").find_export_by_name ("ExitProcess"),
				listener);
#else
