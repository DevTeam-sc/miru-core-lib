namespace Miru {
	public sealed class SpawnMonitor : Object, Mumu.InvocationListener {
		...
		construct {
...
#if WINDOWS
			var kernelbase = Mumu.Process.find_module_by_name ("kernelbase.dll");
			...
			if (create_process_internal == 0) {
				create_process_internal = Mumu.Process.find_module_by_name ("kernel32.dll")
