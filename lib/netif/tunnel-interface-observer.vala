public sealed class Miru.TunnelInterfaceObserver : Object, DynamicInterfaceObserver {
#if IOS || TVOS
	...
	private Darwin.GCD.DispatchQueue event_queue =
		new Darwin.GCD.DispatchQueue ("re.miru.endpoint-enumerator", Darwin.GCD.DispatchQueueAttr.SERIAL);
	...
	public void start () {
		...
		context.info = this;
		store = new Darwin.SystemConfiguration.DynamicStore (null, CoreFoundation.String.make ("Miru"),
