namespace Miru {
	[DBus (name = "re.miru.HostSession17")]
	...
	[DBus (name = "re.miru.AgentSessionProvider17")]
	...
	[DBus (name = "re.miru.AgentSession17")]
	...
	[DBus (name = "re.miru.AgentController17")]
	...
	[DBus (name = "re.miru.MiruMessageSink17")]
	public interface MiruMessageSink : Object {
		public abstract async void post_messages (AgentMessage[] messages, uint batch_id,
			Cancellable? cancellable) throws GLib.Error;
	}
	...
	public sealed class AgentMessageTransmitter : Object {
		...
		public MiruMessageSink? message_sink {
			get;
			set;
		}

		public MainContext miru_context {
			get;
			construct;
		}
...
#endif
		private MiruMessageSink? nice_message_sink;
		...
		public AgentMessageTransmitter (AgentSession agent_session, uint persist_timeout, MainContext miru_context,
				MainContext dbus_context) {
			Object (
				agent_session: agent_session,
				persist_timeout: persist_timeout,
				miru_context: miru_context,
				dbus_context: dbus_context
			);
		}

		construct {
			assert (miru_context != null);
		...
		public void interrupt () throws Error {
			...
			expiry_timer.attach (miru_context);
		}
		...
		private async void complete_peer_connection () {
			try {
				...
				nice_message_sink = yield nice_connection.get_proxy (null, ObjectPath.MIRU_MESSAGE_SINK,
		...
		private void maybe_deliver_pending_messages () {
			...
			MiruMessageSink? sink = (nice_message_sink != null) ? nice_message_sink : message_sink;
			if (sink == null)
				return;
		...
		private void emit_batch (MiruMessageSink sink, Gee.ArrayList<PendingMessage> messages, void * items) {
		...
		private async void deliver_batch (MiruMessageSink sink, Gee.ArrayList<PendingMessage> messages, void * items) {
			bool success = false;
			pending_deliveries++;
			try {
				int n = messages.size;
		...
		protected void schedule_on_miru_thread (owned SourceFunc function) {
			var source = new IdleSource ();
			source.set_callback ((owned) function);
			source.attach (miru_context);
		}
	...
	[DBus (name = "re.miru.GadgetSession17")]
	...
	[DBus (name = "re.miru.ServiceSession17")]
	...
	[DBus (name = "re.miru.TransportBroker17")]
	...
	[DBus (name = "re.miru.PortalSession17")]
	...
	[DBus (name = "re.miru.BusSession17")]
	...
	[DBus (name = "re.miru.AuthenticationService17")]
	...
	public struct DarwinInjectorState {
		public Mumu.MemoryRange? mapped_range;
	}
#endif

#if LINUX
	public struct LinuxInjectorState {
		public int miru_ctrlfd;
	...
	[NoReturn]
	public static void throw_api_error (GLib.Error e) throws Miru.Error, IOError {
		if (e is Miru.Error)
			throw (Miru.Error) e;
	...
	[NoReturn]
	public static void throw_dbus_error (GLib.Error e) throws Miru.Error, IOError {
		...
		if (e is DBusError.UNKNOWN_METHOD) {
			throw new Miru.Error.PROTOCOL ("Unable to communicate with remote miru-server; " +
				"please ensure that major versions match and that the remote Miru has the " +
				"feature you are trying to use");
		}

		throw new Miru.Error.TRANSPORT ("%s", e.message);
	}
	...
	namespace ObjectPath {
		public const string HOST_SESSION = "/re/miru/HostSession";
		public const string AGENT_SESSION_PROVIDER = "/re/miru/AgentSessionProvider";
		public const string AGENT_SESSION = "/re/miru/AgentSession";
		public const string AGENT_CONTROLLER = "/re/miru/AgentController";
		public const string MIRU_MESSAGE_SINK = "/re/miru/MiruMessageSink";
		public const string GADGET_SESSION = "/re/miru/GadgetSession";
		public const string CHANNEL = "/re/miru/Channel";
		public const string SERVICE = "/re/miru/Service";
		public const string TRANSPORT_BROKER = "/re/miru/TransportBroker";
		public const string PORTAL_SESSION = "/re/miru/PortalSession";
		public const string BUS_SESSION = "/re/miru/BusSession";
		public const string AUTHENTICATION_SERVICE = "/re/miru/AuthenticationService";

		public static string for_agent_session (AgentSessionId id) {
			return AGENT_SESSION + "/" + id.handle;
		}

		public static string for_miru_message_sink (AgentSessionId id) {
			return MIRU_MESSAGE_SINK + "/" + id.handle;
		}
