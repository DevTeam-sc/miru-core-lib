namespace Miru {
	...
	[CCode (cheader_filename = "miru-linux-bpf.h", cprefix = "MIRU_BPF_RINGBUF_", has_type_id = false)]
	[Flags]
	...
	[CCode (cheader_filename = "miru-linux-bpf.h")]
	public const uint32 BPF_RINGBUF_HEADER_SIZE;

	[CCode (cheader_filename = "miru-linux-perf-event.h")]
	public const int PERF_EVENT_TYPE_SOFTWARE;

	[CCode (cheader_filename = "miru-linux-perf-event.h")]
	public const int PERF_EVENT_COUNT_SW_CPU_CLOCK;

	[CCode (cheader_filename = "miru-linux-perf-event.h", has_type_id = false)]
