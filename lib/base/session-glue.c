...
gchar *
_miru_query_windows_version (void)
{
...
gchar *
_miru_query_windows_computer_name (void)
{
...
GVariant *
_miru_query_mobile_gestalt (const gchar * query)
{
...
gchar *
_miru_query_android_system_property (const gchar * name)
{
