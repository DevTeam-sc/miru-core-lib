...
static BOOL miru_pipe_is_windows_vista_or_greater (void);
static BOOL miru_pipe_is_windows_8_or_greater (void);
static BOOL miru_pipe_is_windows_version_or_greater (DWORD major, DWORD minor, DWORD service_pack);

LPCWSTR
miru_pipe_get_sddl_string_for_pipe (void)
{
...
static BOOL
miru_pipe_is_windows_vista_or_greater (void)
{
  return miru_pipe_is_windows_version_or_greater (6, 0, 0);
}

static BOOL
miru_pipe_is_windows_8_or_greater (void)
{
  return miru_pipe_is_windows_version_or_greater (6, 2, 0);
}

static BOOL
miru_pipe_is_windows_version_or_greater (DWORD major, DWORD minor, DWORD service_pack)
{
