...
Miru core library intended for static linking into bindings.
...
- Acts as a logistics layer that packages up [MumuJS][] into a shared library.
...
```console
$ pip install miru-tools # CLI tools
$ pip install miru # Python bindings
$ npm install miru # Node.js bindings
```

Or, for static linking into your own project written in a C-compatible language,
download a devkit from the Miru [releases][] page.
