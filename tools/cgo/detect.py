...
MIRU_ABI_TO_MINGW_FLAVOR = {
    "arm64": "clangarm64",
    "x86": "mingw32",
    "x86_64": "mingw64",
}

MIRU_ABI_TO_MINGW_ARCH = {
    "arm64": "aarch64",
    "x86": "i686",
    "x86_64": "x86_64",
}
...
def detect_config(
    ...
    goos = MIRU_OS_TO_GO_OS.get(host_os, host_os)
    goarch = MIRU_ABI_TO_GO_ARCH.get(host_abi, host_abi)
...
class MinGWToolchain:
    ...
    def detect(host_abi: str) -> MinGWToolchain:
        ...
        expected_mingw_arch = MIRU_ABI_TO_MINGW_ARCH[host_abi]
...
def host_abi_to_mingw_flavor(abi: str) -> str:
    try:
        return MIRU_ABI_TO_MINGW_FLAVOR[abi]
    except KeyError:
