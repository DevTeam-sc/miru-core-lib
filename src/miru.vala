[CCode (gir_namespace = "Miru", gir_version = "1.0")]
namespace Miru {
	...
	public sealed class Session : Object, MiruMessageSink {
		...
		private async void do_setup_peer_connection (PeerOptions? options, Cancellable? cancellable) throws Error, IOError {
			...
			try {
				nice_registration_id = nice_connection.register_object (ObjectPath.MIRU_MESSAGE_SINK,
					(MiruMessageSink) this);
	...
	public sealed class Script : Object {
		...
		private Mumu.InspectorServer? inspector_server;
		...
		public async void enable_debugger (uint16 port = 0, Cancellable? cancellable = null) throws Error, IOError {
			...
			inspector_server = (port != 0)
				? new Mumu.InspectorServer.with_port (port)
				: new Mumu.InspectorServer ();
