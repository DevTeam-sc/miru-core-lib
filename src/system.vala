namespace Miru {
	namespace System {
		public extern static Miru.HostApplicationInfo get_frontmost_application (FrontmostQueryOptions options) throws Error;
		public extern static Miru.HostApplicationInfo[] enumerate_applications (ApplicationQueryOptions options);
		public extern static Miru.HostProcessInfo[] enumerate_processes (ProcessQueryOptions options);
	...
	public sealed class TemporaryDirectory {
		...
		public static string make_name () {
			var builder = new StringBuilder ("miru-");
			for (var i = 0; i != 16; i++)
