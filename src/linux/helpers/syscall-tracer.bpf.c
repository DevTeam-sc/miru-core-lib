...
on_sys_enter (struct trace_event_raw_sys_enter * ctx)
{
  ...
  if (nr == MIRU_LINUX_SYSCALL_OPENAT ||
      nr == MIRU_LINUX_SYSCALL_FACCESSAT ||
      nr == MIRU_LINUX_SYSCALL_STATFS ||
#ifdef MIRU_LINUX_SYSCALL_NEWFSTATAT
      nr == MIRU_LINUX_SYSCALL_NEWFSTATAT ||
#endif
      nr == MIRU_LINUX_SYSCALL_READLINKAT)
  {
    ...
    __u16 arg_index = 1;
    if (nr == MIRU_LINUX_SYSCALL_STATFS)
      arg_index = 0;
    ...
    if (nr == MIRU_LINUX_SYSCALL_READLINKAT)
    {
  ...
  if (nr == MIRU_LINUX_SYSCALL_CONNECT)
  {
