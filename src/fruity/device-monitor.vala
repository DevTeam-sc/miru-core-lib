...
namespace Miru.Fruity {
	...
	private sealed class PortableCoreDeviceBackend : Object, Backend, UsbDeviceBackend {
		...
		public async void start (Cancellable? cancellable) throws IOError {
			...
			usb_worker = new Thread<void> ("miru-core-device-usb", perform_usb_work);
	...
	public class Network {
		public static async void wait_until_interfaces_ready (Gee.Collection<string> interfaces, Cancellable? cancellable) throws Error, IOError {
			var main_context = MainContext.get_thread_default ();
