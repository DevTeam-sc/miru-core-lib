#ifndef __MIRU_UPLOAD_API_H__
#define __MIRU_UPLOAD_API_H__
...
typedef struct _MiruUploadApi MiruUploadApi;

struct _MiruUploadApi
{
...
#define MIRU_RX_BUFFER_SIZE (1024 * 1024)
