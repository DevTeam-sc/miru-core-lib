...
namespace Miru.Barebone {
	...
	public void append_memory_scanner_data (BufferBuilder builder, Gee.List<Mumu.MemoryRange?> ranges, MatchPattern pattern,
		...
		try {
			...
			foreach (Mumu.MemoryRange r in ranges) {
				builder
