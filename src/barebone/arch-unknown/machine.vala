...
namespace Miru.Barebone {
	public sealed class UnknownMachine : Object, Machine {
		...
		public UnknownMachine (GDB.Client mdb) {
			Object (mdb: mdb);
		}
		...
		public async Gee.List<uint64?> scan_ranges (Gee.List<Mumu.MemoryRange?> ranges, MatchPattern pattern,
