...
export class BNativePointer {
    ...
    readPointer(): BNativePointer {
        return mdb.readPointer(this.$v);
    }

    writePointer(value: BNativePointer): BNativePointer {
        mdb.writePointer(this.$v, value);
        return this;
    }

    readS8(): number {
        return mdb.readS8(this.$v);
    }

    writeS8(value: number | BInt64): BNativePointer {
        mdb.writeS8(this.$v, value);
        return this;
    }

    readU8(): number {
        return mdb.readU8(this.$v);
    }

    writeU8(value: number | BUInt64): BNativePointer {
        mdb.writeU8(this.$v, value);
        return this;
    }

    readS16(): number {
        return mdb.readS16(this.$v);
    }

    writeS16(value: number | BInt64): BNativePointer {
        mdb.writeS16(this.$v, value);
        return this;
    }

    readU16(): number {
        return mdb.readU16(this.$v);
    }

    writeU16(value: number | BUInt64): BNativePointer {
        mdb.writeU16(this.$v, value);
        return this;
    }

    readS32(): number {
        return mdb.readS32(this.$v);
    }

    writeS32(value: number | BInt64): BNativePointer {
        mdb.writeS32(this.$v, value);
        return this;
    }

    readU32(): number {
        return mdb.readU32(this.$v);
    }

    writeU32(value: number | BUInt64): BNativePointer {
        mdb.writeU32(this.$v, value);
        return this;
    }

    readS64(): BUInt64 {
        return mdb.readS64(this.$v);
    }

    writeS64(value: number | BInt64): BNativePointer {
        mdb.writeS64(this.$v, value);
        return this;
    }

    readU64(): BUInt64 {
        return mdb.readU64(this.$v);
    }

    writeU64(value: number | BUInt64): BNativePointer {
        mdb.writeU64(this.$v, value);
        return this;
    }
    ...
    readFloat(): number {
        return mdb.readFloat(this.$v);
    }

    writeFloat(value: number): BNativePointer {
        mdb.writeFloat(this.$v, value);
        return this;
    }

    readDouble(): number {
        return mdb.readDouble(this.$v);
    }

    writeDouble(value: number): BNativePointer {
        mdb.writeDouble(this.$v, value);
        return this;
    }

    readByteArray(length: number): ArrayBuffer {
        return mdb.readByteArray(this.$v, length);
    }

    writeByteArray(value: ArrayBuffer | number[]): BNativePointer {
        mdb.writeByteArray(this.$v, value);
        return this;
    }

    readCString(size?: number): string {
        return mdb.readCString(this.$v, size);
    }

    readUtf8String(size?: number): string {
        return mdb.readUtf8String(this.$v, size);
    }

    writeUtf8String(value: string): BNativePointer {
        mdb.writeUtf8String(this.$v, value);
        return this;
    }
