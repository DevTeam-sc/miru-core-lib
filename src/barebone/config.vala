...
namespace Miru.Barebone {
	/**
	 * Barebone backend configuration. This is specified via the MIRU_BAREBONE_CONFIG environment
	 ...
	 *  {
	 *    "agent": {
	 *      "path": "/path/to/target/aarch64-unknown-none/release/miru-barebone-agent",
	 *      "transport": {
	 *        "type": "hostlink",
