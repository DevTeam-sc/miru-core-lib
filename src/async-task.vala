internal abstract class Miru.AsyncTask<T> : Object {
	...
	// FIXME: Work around Vala compiler bug where it fails to include miru-core.h
	[CCode (cname = "miru_get_main_context")]
