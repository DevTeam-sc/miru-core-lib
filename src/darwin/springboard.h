#ifndef __MIRU_DARWIN_SPRINGBOARD_H__
#define __MIRU_DARWIN_SPRINGBOARD_H__

#include <glib.h>
#import <UIKit/UIKit.h>

typedef struct _MiruSpringboardApi MiruSpringboardApi;
...
G_GNUC_INTERNAL MiruSpringboardApi * _miru_get_springboard_api (void);
